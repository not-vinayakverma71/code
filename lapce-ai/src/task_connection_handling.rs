...
pub struct AskResponse {
    pub response: crate::ipc_messages::ClineAskResponse,
    pub text: Option<String>,
    pub images: Option<Vec<String>>,
}

// Use ClineAsk and ToolProgressStatus from ipc_messages
use crate::ipc_messages::{ClineAsk, ToolProgressStatus};

// Extension methods for ClineMessage are already in ipc_messages.rs
