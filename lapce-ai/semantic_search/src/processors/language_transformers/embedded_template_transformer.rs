...
pub struct Embedded_templateTransformer;

impl LanguageTransformer for Embedded_templateTransformer {
    fn transform(&self, node: &tree_sitter::Node, source: &str) -> Result<AstNode> {
        Ok(AstNode {
            ...
            metadata: NodeMetadata {
                ...
                source_file: None,
                language: "embedded_template".to_string(),
                complexity: 0,
                stable_id: None,
            },
            semantic_info: None,
    ...
    fn language_name(&self) -> &'static str { "embedded_template" }
}
