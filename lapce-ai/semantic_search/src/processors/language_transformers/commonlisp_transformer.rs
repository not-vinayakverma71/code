...
pub struct CommonlispTransformer;

impl LanguageTransformer for CommonlispTransformer {
    ...
    fn language_name(&self) -> &'static str { "commonlisp" }
}
