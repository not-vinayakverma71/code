...
pub fn run_comprehensive_benchmark() -> BenchmarkResult {
    ...
    let languages = vec![
        ("JavaScript", tree_sitter_javascript::LANGUAGE.into(), JAVASCRIPT_CODE),
        ("TypeScript", tree_sitter_typescript::LANGUAGE_TYPESCRIPT.into(), TYPESCRIPT_CODE),
        ("TSX", tree_sitter_typescript::LANGUAGE_TSX.into(), TSX_CODE),
