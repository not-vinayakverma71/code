...
impl ClineProvider {
    // post_message_to_webview removed - avoiding duplicate definitions
}
...
impl TaskApiHandler {
    ...
    ) -> Result<crate::stream_transform::ApiStream, crate::stream_transform::ApiError> {
        Err(crate::stream_transform::ApiError {
