...
use crate::stream_transform::{ApiStreamChunk, ApiError, ApiStream};
...
impl Task {
    ...
    pub async fn attempt_api_request(
        ...
        let stream = if let Some(ref api) = self.api {
            ...
            return Err(crate::stream_transform::ApiError {
...
use crate::stream_transform::ApiError as StreamApiError;
